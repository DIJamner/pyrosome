...
open import V2.Var hiding (z; s)
open import Relation.Unary
open import V2.Environment as E hiding (sequenceA)

-- Descriptions and their Interpretation

private variable ℓ ℓ₁ ℓ₂ : Level

data Desc (I : Set ℓ) : Set (suc ℓ) where
  `σ : (A : Set) → (A → Desc I)  → Desc I
  `X : List I → I → Desc I       → Desc I
  `∎ : I                         → Desc I

reindex : {I : Set ℓ₁} → {J : Set ℓ₂} → (I → J) → Desc I → Desc J
...
module _ {I : Set ℓ} {i Γ} {d : Desc I} where
...
module _ {I : Set ℓ} {d e : Desc I} {X : List I → I ─Scoped}
         {A : Set ℓ₁} {i : I} {Γ : List I} where
...
{-
TODO
module _ {I : Set ℓ} {d : Desc I} {X : List I → I ─Scoped} {i : I} {Γ : List I} where
