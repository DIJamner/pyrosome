...
From Named Require Import Core Elab Matches VSubst.
Import Core.Notations.

Require Coq.derive.Derive.


Definition forall_def : lang :=
  {[l/subst
  [:| "G" : #"env",
      "A" : #"ty" (#"tyext" "G")
      -----------------------------------------------
  ...
  [:| "G" : #"env",
       ...
       "A" : #"ty" "G"
       -----------------------------------------------
       #"@" "e" "A" : #"exp" "G" (#"ty_subst" (#"tysnoc" #"id" "A") "B")
  ];
  [:= "G" : #"env",
      "B" : #"ty" (#"tyext" "G"),
      "e" : #"exp" (#"tyext" "G") "B",
      ...
      ----------------------------------------------- ("all-beta")
      #"@" (#"ret" (#"Lambda" "e")) "A"
      = #"exp_subst" (#"tysnoc" #"id" "A") "e"
      : #"exp" "G" (#"ty_subst" (#"tysnoc" #"id" "A") "B")
  ]
  ]}.
(*
  1. add unif vars
 ...
 *)
    ...
    Ltac split_sub s :=
       ...
       Hint Resolve (inst_for_db "tyext") : injective_con.
       Hint Resolve (inst_for_db "all") : injective_con.
...
Derive forall_lang
       SuchThat (elab_lang_ext (tyext++exp_subst++value_subst) forall_def forall_lang)
       As forall_lang_wf.
Proof. auto_elab. Qed.
#[export] Hint Resolve forall_lang_wf : elab_pfs.
