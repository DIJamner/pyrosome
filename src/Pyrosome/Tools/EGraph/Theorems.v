...
(* ============================================================== *)
(* [E] establishment (post-WithVar): the good_worklist witness    *)
(* for the add_ctx output.  Placed after [End WithVar] because the *)
(* proof references the [add_open_sort] lemmas in their fully-     *)
(* closed signatures (transplanted verbatim from the validated     *)
(* WIP/CtxGoodWorklist.v, 0-axiom).  [add_ctx_good_worklist]        *)
(* discharges the [E] hypothesis of [add_ctx_inversion].          *)
(* ============================================================== *)
Section WithVar.
  Context (V : Type)
    {V_Eqb : Eqb V}
