...
record _─Env {ℓ : Level} {I : Set ℓ} (Γ : List I) (𝓥 : I ─Scoped) (Δ : List I) : Set (suc ℓ) where
  constructor pack
...
Thinning : ∀ {ℓ} → {I : Set ℓ} → List I → List I → Set (suc ℓ)
...
data Split {ℓ} {I : Set ℓ} (i : I) Γ Δ : Var i (Γ ++ Δ) → Set (suc ℓ) where
