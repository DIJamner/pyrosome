...
- lazymatch goal with
  ...
  eapply eq_term_trans.
  {
    ...
    {
      eapply eq_term_conv.
      1:eapply eq_term_trans;
      [ term_cong | eredex_steps_with linear_value_subst "cmp_csub"  ].
      5: term_refl.
      4: term_refl.
      1-3: by_reduction; now t'.
      1: repeat t'.
      1: sort_cong;by_reduction; now t'.
    }
...
- 
    ...
    Require Import EGraph.Automation EGraph.ComputeWf.
