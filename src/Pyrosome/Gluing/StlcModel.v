...
Lemma envok_emp_ok : EnvOk Emp.
Proof. constructor. Qed.

(* Environments are generated by [emp]/[ext] only, so an [EnvOk] environment is
   either empty or an extension -- the case analysis the substitution relation
   recurses on. *)
Lemma EnvOk_inv G
  : EnvOk G -> G = Emp \/ exists G' A, G = Ext G' A /\ EnvOk G' /\ TyOk A.
Proof.
  destruct 1; eauto 10.
Qed.
