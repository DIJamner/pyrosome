    ...
    - destruct ci0 as [|b ci0']; [cbn in Hci0_len; discriminate|].
      ...
      + (* have_true *)
        ...
        { intros xx ll Hrectxl.
          apply (pt_spaced_intersect'_sim_rev fuel' (length x') foc fot tci0 tcil xx ll).
        ...
        pose proof (list_intersect_lookup_at_pos fuel' (length x') foc fot tci0 tcil tpt0 tptl q
